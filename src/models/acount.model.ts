...
export class Acount extends Entity {
  ...
  @property({
    ...
    precision: 10,
    scale: 0,
    mssql: {columnName: 'id_role', dataType: 'int', dataLength: null, dataPrecision: 10, dataScale: 0, nullable: 'YES'},
  })
  idRole?: number;
  ...
  @property({
    ...
    required: false,
    length: 50,
    mssql: {columnName: 'user_name', dataType: 'nvarchar', dataLength: 50, dataPrecision: null, dataScale: null, nullable: 'YES'},
  })
  userName?: string;
  ...
  @property({
    ...
    required: false,
    length: 50,
    mssql: {columnName: 'password', dataType: 'nvarchar', dataLength: 50, dataPrecision: null, dataScale: null, nullable: 'YES'},
  })
  password?: string;
