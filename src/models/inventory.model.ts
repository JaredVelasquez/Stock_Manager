...
export class Inventory extends Entity {
  ...
  @property({
    ...
    precision: 10,
    scale: 0,
    mssql: {columnName: 'id_producto', dataType: 'int', dataLength: null, dataPrecision: 10, dataScale: 0, nullable: 'YES'},
  })
  idProducto?: number;
  ...
  @property({
    ...
    precision: 10,
    scale: 0,
    mssql: {columnName: 'stock', dataType: 'int', dataLength: null, dataPrecision: 10, dataScale: 0, nullable: 'YES'},
  })
  stock?: number;
